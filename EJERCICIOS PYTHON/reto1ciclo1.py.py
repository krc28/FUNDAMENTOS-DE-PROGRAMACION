"""El siguiente código ha perdido algunas de sus líneas.  Su trabajo es completar las líneas de código que faltan, las cuales están marcadas claramente con textos que 
describen lo que la línea debe hacer.  Estas líneas faltantes son de color morado y empiezan por #.
Todo el programa realiza las siguientes acciones:
Se genera un entero entre 15 y 25; luego se construye un objeto de la clase vector (esta clase ya existe) tal como la definida en el curso.  El tamaño del vector es el número 
generado inicialmente. Luego, se llena el vector con números enteros entre 1 y 99 generados aleatoriamente.
Con el vector creado se construye un nuevo vector, el cual debe contener el máximo común divisor y el mínimo común múltiplo de: el primer número y el segundo, 
el tercero y el cuarto, el quinto y el sexto y así sucesivamente. Por ejemplo, si en el vector a procesar en las dos primeras posiciones están los números (posición 1)36 y 
(Posición 2) 48 entonces en las dos primeras posiciones del vector construido estarán 12(Máximo común divisor de 36 y 48) y 144(mínimo común múltiplo de 36 y 48). Si el tamaño del 
vector es impar, el número que se quede sin pareja no será tomado en cuenta.
Por el ejemplo:
